...
public class LawnMownerTest {
	...
	public void lawnMownerTest1() {
		...
		assertEquals("Wrong X coordinate", Integer.valueOf(1), finalPosition.getCoordinates().getX());
		assertEquals("Wrong Y coordinate", Integer.valueOf(3), finalPosition.getCoordinates().getY());
	}
	...
	public void lawnMownerTest2() {
		...
		assertEquals("Wrong X coordinate", Integer.valueOf(5), finalPosition.getCoordinates().getX());
		assertEquals("Wrong Y coordinate", Integer.valueOf(1), finalPosition.getCoordinates().getY());
	}
}
